...
## Part 5 - Transmission of logged Data via PROFINET
...
![IEC_Program](/Picture/15_RT_DataLogger_app_overview.png)
...
1. Include into Project `CppDataLoggerComponent` the method " GetRecord" and execute this metod in real-time program "CppDataLoggerProgram" for data providing to Profinet send buffer:
 ...
 - Include the method "GetRecord" and adapt the methods "ReadVariablesDataToByte" and "workerThreadBody" in "CppDataLoggerComponent.cpp" file as follows:
