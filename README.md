...
Implementation in PLCnext Technology **Firmware 2025.6**.  
...
|\#| Topic | Objectives |
| --- | ------ | ------ |
|[01](getting-started/Part-01/README.md)| [PLCnext Engineer Project](getting-started/Part-01/README.md)| Create a simple PLCnext Engineer Project with Datalogger Service to log the port variables.|
|[02](getting-started/Part-03/README.md)| [OPC UA Historical Access](getting-started/Part-03/README.md)| Make data in the datalogger application available through an OPC UA server.|
|[03](getting-started/Part-04/README.md)| [Using RSC Services for getting DataLogger configuration](getting-started/Part-03/README.md)| Implement "IDataLogger" RSC service and read the datalogger configuration back from the service.|
|[04](getting-started/Part-05/README.md)| [Using RSC Services for access to logged Data](getting-started/Part-04/README.md)| Use the "IDataLogger" RSC service to read in the logged data from a data sink.|
|[05](getting-started/Part-06/README.md)| [Transmission of logged Data via PROFINET](getting-started/Part-05/README.md)| Transmit the logged data via PROFINET to another PN-Device.|
...
* You can get support or provide suggestion and ideas in the forum of the [PLCnext Community](https://www.plcnext-community.net/forum/#/categories).
* Request a new feature or example to be added on [GitHub](CONTRIBUTING.md)
* File a bug in [GitHub Issues](https://github.com/PLCnext/PLCnext_RT_Datalogger/issues)
